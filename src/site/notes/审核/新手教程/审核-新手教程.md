---
{"dg-publish":true,"dg-home":true,"dg-note-icon":3,"tags":["dg-publish","gardenEntry"],"permalink":"/审核/新手教程/审核-新手教程/","dgPassFrontmatter":true,"noteIcon":3,"updated":"2024-10-26T20:15:15.084+08:00"}
---
  ...
  <div class="tab-wrap">
    ...
    <h3>👉🏼画面</h3>
	    <li><font color="#ff0000">剪辑画面</font>请分为<font color="#ff0000">上中下</font>三个屏幕
		      <div>
			 <span class="tooltip" data-tooltip="中间主屏幕请<font color='#ff0000'>明显大于</font>上下屏幕">!</span>
			 </div>
		</li>
		<li>
		上下屏幕放以前剪过的短视频
			<div>
			<span class="tooltip" data-tooltip="虽然以前剪过，但组合在一起就是新的画面，可以减少重复率">!</span>
			</div>
		或其他你认为可以<font color="#ff0000">减少重复率</font>的素材
			<div>
			<span class="tooltip" data-tooltip="比如别人新发的，或冷门的，播放量比较少的">!</span>
			</div>
		</li>
