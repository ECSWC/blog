---
{"dg-publish":true,"dg-home":true,"dg-note-icon":3,"tags":["dg-publish","gardenEntry","gardenEntry"],"permalink":"/兼职审核/新手教程/审核-新手教程/","dgPassFrontmatter":true,"noteIcon":3,"updated":"2024-12-19T15:06:10.993+08:00"}
---
...
## 📢公告栏
  <div class="tab-wrap">
    ...
    <label for="tab3">🎁友情链接</label>
    <div class="tab__content">
      <h3><font color="#ff0000">🎬剪辑要求更新</font></h3>
      <ul>
    <h6>🎑画面</h6>
	    <li><font color="#ff0000">剪辑画面</font>请分为<font color="#ff0000">上中下</font>三个屏幕
		    <dfn data-info="中间主屏幕请明显大于上下屏幕">🍊</dfn>
		</li>
		<li>上下屏幕放以前剪过的短视频
			<dfn data-info="虽然以前剪过，但组合在一起就是新的画面，可以减少重复率">🍊</dfn>
		或其他你认为可以<font color="#ff0000">减少重复率</font>的素材
			<dfn data-info="比如别人新发的，或冷门的，播放量比较少的">🍊</dfn>
		</li>
...
<li>关于商家<font color='#ff0000'>必须出现的卖点</font>，虽然遗漏了可以用字幕加上，但是出现在文案里可能会更好</li><li>比较<font color="#ff0000">省事的办法</font>是，写文案的时候自由发挥，然后<font color="#ff0000">让ChatGPT检查</font>是否遗漏“…”，并加进文案里 </li> 
    ...
    <div class="tab__content">
	    <h3>
		    <a href="https://waytoagi.feishu.cn/wiki/QPe5w5g7UisbEkkow8XcDmOpn8e" class="BlueButton">🌈通往AGI之路</a>
		</h3>
    </div>
</div>
